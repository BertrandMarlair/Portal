        ...
        <ConnectLayout>
            <div className={classes.container}>
                ...
                <form className={classes.form} onSubmit={e => handleSubmit(e)}>
                    ...
                    <Input onChange={e => setEmail(e.target.value)} value={email} name="email" type="email" placeholder="Exemple@company.com" autoComplete="email"/>
                    <SmallTitle error>{emailError}</SmallTitle>
                    <Input onChange={e => setPassword(e.target.value)} value={password} name="password" type="password" placeholder="Password" autoComplete="current-password"/>
